...
import com.demo.sp.model.ResultMap;
import com.demo.sp.model.TokenDetail;
import com.demo.sp.model.vo.Data;
import com.demo.sp.model.vo.RequestLoginUser;
...
public class LoginController
{
    ...
    public ResultMap login(@Valid RequestLoginUser requestLoginUser, BindingResult bindingResult)
    {
        ...
        return new ResultMap().success().message("")
                .data(new Data().addObj(tokenHeader, loginService.generateToken((TokenDetail) loginDetail)));
    }
