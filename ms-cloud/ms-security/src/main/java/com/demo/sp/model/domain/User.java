package com.demo.sp.model.domain;
...
public class User implements LoginDetail, TokenDetail
{
    ...
    {
        return "User{" + "username='" + username + '\'' + ", password='" + password + '\'' + ", authorities='"
                + authorities + '\'' + ", lastPasswordChange=" + lastPasswordChange + ", enable=" + enable + '}';
    }
}
